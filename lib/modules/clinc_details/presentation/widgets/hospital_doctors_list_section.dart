...
class HospitalDoctorsListSection extends StatelessWidget {
  const HospitalDoctorsListSection({super.key, required this.doctors});
      ...
      children: [
        ...
        doctors.isEmpty
            ? SharedEmptyWidget(
                ...
                subtitle: tr(LocaleKeys.clinic_app_details_no_doctors_subtitle),
              )
            : ListView.builder(
                shrinkWrap: true,
                ...
                itemBuilder: (context, index) {
                  ...
                  return FadeInUp(
                    ...
                    child: GestureDetector(
                      onTap: () =>
                          Get.toNamed(AppRoutes.doctorDetails, arguments: doc),
                      child: Container(
