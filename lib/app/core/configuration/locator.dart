...
import '../../data/app_settings_remote_data_source.dart';
...
import '../../../modules/appointments/data/appointments_remote_data_source.dart';
...
import '../../../modules/book_appointments/data/book_appointment_remote_data_source.dart';
...
import '../../../modules/my_appointment_details/data/my_appointment_details_remote_data_source.dart';
...
void setupLocator() {
  ...
  if (!locator.isRegistered<AppSettingsDataSource>()) {
    locator.registerLazySingleton<AppSettingsDataSource>(
      () => AppSettingsRemoteDataSource(locator<ApiServices>()),
    );
  }
  if (!locator.isRegistered<AppSettingsRepository>()) {
    locator.registerLazySingleton<AppSettingsRepository>(
      () => AppSettingsRepository(locator<AppSettingsDataSource>()),
    );
  }
  ...
  if (!locator.isRegistered<AppointmentsDataSource>()) {
    locator.registerLazySingleton<AppointmentsDataSource>(
      () => AppointmentsRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<BookAppointmentDataSource>()) {
    locator.registerLazySingleton<BookAppointmentDataSource>(
      () => BookAppointmentRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<ChatbotDataSource>()) {
    locator.registerLazySingleton<ChatbotDataSource>(
      () => ChatbotRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<ClinicDetailsDataSource>()) {
    locator.registerLazySingleton<ClinicDetailsDataSource>(
      () => ClinicDetailsRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<ContactDataSource>()) {
    locator.registerLazySingleton<ContactDataSource>(
      () => ContactRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<HomeDataSource>()) {
    locator.registerLazySingleton<HomeDataSource>(
      () => HomeRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<InsuranceDataSource>()) {
    locator.registerLazySingleton<InsuranceDataSource>(
      () => InsuranceRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<LabsDataSource>()) {
    locator.registerLazySingleton<LabsDataSource>(
      () => LabsRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<MyAppointmentDetailsDataSource>()) {
    locator.registerLazySingleton<MyAppointmentDetailsDataSource>(
      () => MyAppointmentDetailsRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<NotificationsDataSource>()) {
    locator.registerLazySingleton<NotificationsDataSource>(
      () => NotificationsRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<PaymentDataSource>()) {
    locator.registerLazySingleton<PaymentDataSource>(
      () => PaymentRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<DoctorsDataSource>()) {
    locator.registerLazySingleton<DoctorsDataSource>(
      () => DoctorsRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<SearchDataSource>()) {
    locator.registerLazySingleton<SearchDataSource>(
      () => SearchRemoteDataSource(locator<ApiServices>()),
    );
  }
  ...
  if (!locator.isRegistered<SettingsDataSource>()) {
    locator.registerLazySingleton<SettingsDataSource>(
      () => SettingsRemoteDataSource(locator<ApiServices>()),
    );
  }
